...
PREFIX="ice_drift_sh_polstere-625_multi-oi_" # ice_conc_sh_polstere-100_multi_201901011200.nc

#ftp://osisaf.met.no/archive/ice/drift_lr/merged/2019/01/ice_drift_sh_polstere-625_multi-oi_201812301200-201901011200.nc
...
PATH_OUT=/Users/rsan613/n/southern/data/drift_osisaf/
PATH_OUT=/scale_wlg_nobackup/filesets/nobackup/uoa03669/data/drift_osisaf/
...
while [ ${current} -le ${limite} ]; do
  ...
  current2=`date -u -d "${current} +2 day" +%Y%m%d`

  SOURCE=ftp://osisaf.met.no/archive/ice/drift_lr/merged/${YEAR}/${MONTH}/${PREFIX}${current}"1200-"${current2}"1200.nc"

  echo "${SOURCE}"
  exit 0

  OUTPUT=${PREFIX}${current}"1200-"${current2}"1200.nc"
